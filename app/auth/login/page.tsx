      ...
      <Card className="w-full max-w-md bg-[#121225] text-white border border-[#0072FF]/30 rounded-xl shadow-lg shadow-[#0072FF]/10 backdrop-blur-sm relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <a href="/auth/forgot-password" className="text-xs text-[#05E6C1] hover:text-[#05E6C1]/90 transition-colors font-medium">
                  Forgot password?
                </a>
              </div>
              <Input
        ...
        <CardFooter className="flex justify-center pb-6">
          <p className="text-sm text-[#E0E0E0]/70">
            ...
            <a href="/auth/register" className="text-[#05E6C1] hover:text-[#05E6C1]/90 transition-colors font-medium">
              Create an account
            </a>
          </p>
        </CardFooter>
